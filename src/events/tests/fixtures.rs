...
impl EventHandler for ConsumeHandler {
    fn handle_key_event(&mut self, _state: &mut AppState, _key_event: &KeyEvent) -> EventResult {
    ...
    fn handle_mouse_up(&mut self, _state: &mut AppState, _mouse_event: &MouseEvent) -> EventResult {
        self.called.mark_called();
        EventResult::Consumed
    }
...
impl EventHandler for QuitHandler {
    fn handle_key_event(&mut self, _state: &mut AppState, key_event: &KeyEvent) -> EventResult {
